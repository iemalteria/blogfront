    ...
    return(
       <div className='container-index'>
            <div className='image1'>
                <img className='home-image' src="https://backend-nu-virid.vercel.app/uploads/img1.jpeg"  alt='img1'/>
                <div className="image-content">
                    <h1>Institución Educativa <br/> Maltería</h1>
                    <img src="https://backend-nu-virid.vercel.app/uploads/logo.png" alt='logo' />
                </div>
            </div>
            <div className='info-general'>
                <div className='mision'>
                    ...
                    <img src="https://backend-nu-virid.vercel.app/uploads/mision.svg" alt="mision"/>
                </div>
                <div className='vision'>
                    ...
                    <img src="https://backend-nu-virid.vercel.app/uploads/vision.png" alt="vision"/>
                </div>
            </div>
            ...
            <div className='semilleros'>
                ...
                <div className="card-container">
                    {/* Card 1 */}
                    <div className="card">
                        <img src="https://backend-nu-virid.vercel.app/uploads/musica.jpeg" alt="Semillero 1" />
                        <h3>Semillero de Formación Musical</h3>
                    </div>
                    {/* Card 2 */}
                    <div className="card">
                        <img src="https://backend-nu-virid.vercel.app/uploads/emprendimiento.jpeg" alt="Semillero 2" />
                        <h3>Semillero de Emprendimiento</h3>
                    </div>
                    {/* Card 3 */}
                    <div className="card">
                        <img src="http://backend-nu-virid.vercel.app/uploads/boxeo2.jpeg" alt="Semillero 3" />
                        <h3>Semillero de Boxeo</h3>
                    </div>
                    {/* Card 4 */}
                    <div className="card">
                        <img src="http://backend-nu-virid.vercel.app/uploads/futbol2.jpeg" alt="Semillero 4" />
                        <h3>Semillero de Fútbol</h3>
                    </div>
                    {/* Card 5 */}
                    <div className="card">
                        <img src="https://backend-nu-virid.vercel.app/uploads/ambiental.jpeg" alt="Semillero 5" />
                        <h3>Semillero Ambiental</h3>
                    </div>
                    {/* Card 6 */}
                    <div className="card">
                        <img src="https://backend-nu-virid.vercel.app/uploads/danza2.png" alt="Semillero 6" />
